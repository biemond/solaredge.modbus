...
const client = new modbus.client.TCP(socket, 247, 1000);
const client2 = new modbus.client.TCP(socket, 1, 1000);
const client3 = new modbus.client.TCP(socket, 247, 1000);

const clients = [client2, client, client3];
